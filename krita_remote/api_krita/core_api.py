...
from krita import Krita as Api, Extension, qApp, DockWidget, DockWidgetFactory, DockWidgetFactoryBase
...
class KritaInstance:
    ...
    def add_dock_widget(self, factory : DockWidget, id : str) -> None:
        """Add extension/plugin/add-on to krita."""
        self.instance.addDockWidgetFactory(DockWidgetFactory(id,DockWidgetFactoryBase.DockRight,factory))
